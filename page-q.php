        ...
        <body>
            ...
            <div class="main">
                <div class="container-fluid bootstrap-iso">
                    <div class="row">
                        <form class="form" data-toggle="validator" role="form" id="qform" name="qform" enctype="multipart/form-data">
                                            ...
                                            <div class="well">
                                                <fieldset class="contactInfo">
                                                    ...
                                                    <div class="row margin-top-20">
                                                        <div class="form-group xrequired margin-top-20">
                                                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                                                            <div class="col-md-4" id="submitterName">
                                                                <input id="fullName" required="true" name="fullName" type="text" placeholder="Your Name" class="submName form-control ">
                                                            </div>
                                                    ...
                                                    <div class="row margin-top-20">                                                    
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 submEmail" id="submittersEmail">
                                                                <input id="email" required="true" name="qemail" type="email" placeholder="Email Address" class="submEmail form-control " data-error="Bruh, that email address is invalid">
                                                            </div>
                                                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-phone-square bigicon"></i></span>
                                                            <div class="col-md-4 submPhone"  id="submittersPhone">
                                                                <input id="phone" required="true" name="qphone" type="text" placeholder="Phone" class="submPhone form-control ">
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    <div class="row margin-top-20">                                                        
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 submAddr1"  id="address1">
                                                                <input id="qaddr1" required="true" name="qaddr1" type="text" placeholder="Address 1" class="submAddr1 form-control ">
                                                            </div>
                                                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-map-o bigicon"></i></span>
                                                            <div class="col-md-4 submAddr2"  id="address2">
                                                                <input id="qaddr2"  name="qaddr2" type="text" placeholder="Address 2" class="submAddr2 form-control">                                                            
                                                            </div>
                                                        </div>    
                                                    </div>
                                                    <div class="row margin-top-20">                                                        
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 submCity"  id="city">
                                                                <input id="qCity" required="true" name="qcity" type="text" placeholder="City" class="addrCity form-control ">
                                                            </div>
                                                            <!--<span class="col-md-2 col-md-offset-2 text-center"></span>-->
                                                            <div class="col-md-2 submState "  id="state">
                                                                <input id="qState" required="true" name="qstate" type="text" placeholder="State" class="addrState form-control">                                                            
                                                            </div>
                                                            <!--<span class="col-md-1 col-md-offset-2 text-center"></i></span>-->
                                                            <div class="col-md-2 submZip "  id="zip">
                                                                <input id="qzip" required="true" name="qzipcode" type="text" placeholder="Zip" class="addrZip form-control">
                                                            </div>
                                                        </div>  
                                                    </div>  
